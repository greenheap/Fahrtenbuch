...
def render_add_trip_form(repository):
    ...
    with st.form("add_trip_form"):
        ...
        km_start = st.number_input("km Start", min_value=0.0, step=1.0, format="%.1f")
        km_end = st.number_input("km Ende", min_value=0.0, step=1.0, format="%.1f")
        ...
        fuel_price_input = st.number_input("Benzinpreis EUR/L (optional, 0 = kein Eintrag)", min_value=0.0, step=0.01, format="%.2f")
