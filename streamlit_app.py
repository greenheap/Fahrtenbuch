...
def render_add_trip_form(repository):
    ...
    latest_fuel_end = repository.get_latest_fuel_end() or 0
    with st.form("add_trip_form"):
        ...
        fuel_start = st.number_input("Tank Start (0-20)", min_value=0, max_value=20, step=1, value=latest_fuel_end)
        fuel_end = st.number_input("Tank Ende (0-20)", min_value=0, max_value=20, step=1, value=latest_fuel_end)
