...
def test_given_empty_database_when_getting_latest_km_end_then_returns_none(repository):
    result = repository.get_latest_km_end()

    assert result is None


def test_given_single_trip_when_getting_latest_km_end_then_returns_its_km_end(repository):
    trip = {"datum": "2026-05-01", "km_start": 1000.0, "km_end": 1100.0, "fuel_start": 10, "fuel_end": 8, "fuel_price": None}
...
def test_given_multiple_trips_when_getting_latest_km_end_then_returns_last_trips_km_end(repository):
    trip_one = {"datum": "2026-05-01", "km_start": 1000.0, "km_end": 1100.0, "fuel_start": 10, "fuel_end": 8, "fuel_price": None}
    trip_two = {"datum": "2026-05-10", "km_start": 1100.0, "km_end": 1300.0, "fuel_start": 8, "fuel_end": 5, "fuel_price": None}
